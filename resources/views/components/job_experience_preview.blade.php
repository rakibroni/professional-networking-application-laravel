...
<div class="py-1 mb-2 px-1">
  <div class="align-self-center br ps-2 ps-lg-3 pe-2" style="overflow: hidden; height: 55px; border: 0.5px solid #BCBBBB;" id="preview_job_experience{{ $jobExperience->id }}">
    <div class="d-flex mt-2 align-self-center justify-content-between" id="jobExperience_preview_text{{ $jobExperience->id }}">
      ...
      <div class="align-self-center">
        <button class="me-1 btn btn-light-outline btn-sm" style="box-shadow: unset !important" id="edit_jobEpxerience{{ $jobExperience->id }}">
          <img class="d-block d-lg-none" src="/images/Pen.svg" style="height: 20px" alt="">
          <span class="d-none d-lg-block">Bearbeiten</span>
        </button>
      </div>
      <div class="align-self-center">
        <button class="btn btn-light-outline btn-sm" style="box-shadow: unset !important" id="try_delete_jobEpxerience{{ $jobExperience->id }}">
          <img class="d-block d-lg-none" src="/images/DeleteIcon.svg" style="height: 20px" alt="">
          <span class="d-none d-lg-block">Löschen</span>
        </button>
      </div>
    </div>
    <div class="d-flex mt-2 justify-content-between d-none" id="jobExperience_delete_text{{ $jobExperience->id }}">
      <div class="" style="margin-top: 8px">
        Bist du sicher?
      </div>
      <div style="margin-top: 5px">
        <button class="btn btn-danger btn-sm" id="final_delete_jobEpxerience{{ $jobExperience->id }}">Löschen</button>
        <button class="btn btn-light-outline btn-sm" style="box-shadow: unset !important" id="discard_jobEpxerience{{ $jobExperience->id }}">Abbrechen</button>
      </div>
    </div>
  </div>
</div>
